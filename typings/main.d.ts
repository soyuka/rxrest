...
declare interface RxRestItemInterface<T> extends RxRestItem<T> {}
...
declare interface RxRestCollectionInterface<T> extends RxRestCollection<T> {}
...
declare interface ErrorInterceptor {
  (response: Response): Stream<Response>|void|Response|Promise<Response>;
}

declare type BodyParam<T> = RxRestItem<T>|FormData|URLSearchParams|Body|Blob|undefined|Object;

declare interface RequestBodyHandler<T> {
  (body: BodyParam<T>): FormData|URLSearchParams|Body|Blob|undefined|string|Promise<any>
}

declare interface ResponseBodyHandler {
  (body: Response): Promise<any>
}

declare interface ErrorResponse extends Response {
  name: string;
  message: string;
}
 ...
 */
declare interface FixedHeaders extends Map<string, string> {
  append: (name: string, value: string) => void;
  getAll: () => Object[];
}

declare interface RequestWithHeaders extends Request {
