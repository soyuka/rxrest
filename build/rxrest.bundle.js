...
function fetch(input, init, abortCallback) {
    ...
    return from(input.text()).pipe(mergeMap(function (body) {
        req.send(body);
...
var RxRest = function () {
     ...
     */
    function RxRest() {
        var config$$1 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new RxRestConfiguration$$1();
    ...
    createClass(RxRest, [{
        ...
        value: function expandInterceptors(interceptors) {
            return function (origin) {
                return interceptors.reduce(function (obs, interceptor) {
                    return obs.pipe(concatMap(function (value) {
        ...
        value: function request(method, body) {
            ...
            var stream = of(request).pipe(mergeMap(this.expandInterceptors(this.config.requestInterceptors)), mergeMap(function (request) {
                ...
                return from(_this.config.responseBodyHandler(body));
            ...
            }), catchError(function (body) {
                return of(body).pipe(mergeMap(_this.expandInterceptors(_this.config.errorInterceptors)), mergeMap(function (body) {
