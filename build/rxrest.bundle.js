...
Observable_1.Observable.fromPromise = fromPromise$3.fromPromise;
...
var MergeMapSubscriber = (function (_super) {
    __extends$4(MergeMapSubscriber, _super);
...
RequestBase.prototype.send = function(data){
  ...
  // merge
  if (isObj && isObject_1$3(this._data)) {
    for (var key in data) {
...
function serialize(obj) {
  if (!isObject_1$3(obj)) return obj;
  var pairs = [];
  for (var key in obj) {
...
var RxRest$1 = function () {
    ...
    createClass(RxRest, [{
        ...
        value: function request(method, body) {
            ...
            var stream = Observable_2.of(request).mergeMap(this.expandInterceptors(this.config.requestInterceptors)).mergeMap(function (request) {
                ...
                return Observable_2.of(body).mergeMap(_this.expandInterceptors(_this.config.errorInterceptors)).mergeMap(function (body) {
                    return Observable_2.throw(body);
                });
            });
            return stream;
        }
