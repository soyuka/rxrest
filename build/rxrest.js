    ...
    createClass(RxRest, [{
        ...
        value: function expandInterceptors(interceptors) {
            return function (origin) {
                ...
                }, Observable.Observable.of(origin));
            };
        }
        /**
         * request
        ...
        value: function request(method, body) {
            ...
            var stream = Observable.Observable.of(request).mergeMap(this.expandInterceptors(this.config.requestInterceptors)).mergeMap(function (request) {
                return _this.config.fetch(request, null, _this.config.abortCallback);
            }).mergeMap(this.expandInterceptors(this.config.responseInterceptors)).mergeMap(function (body) {
                ...
                return Observable.Observable.of(body).mergeMap(_this.expandInterceptors(_this.config.errorInterceptors)).mergeMap(function (body) {
                    return Observable.Observable.throw(body);
                });
            });
            return stream;
        }
